...
# load data from MetaMS analysis (out)
load("golden_pos_metams.RData")

# get the data-matrix and replace rownames
DM <- t(out$PeakTable[,6:146])
rownames.new <- read.table("golden_pos_new_rownames.csv", header=FALSE)
